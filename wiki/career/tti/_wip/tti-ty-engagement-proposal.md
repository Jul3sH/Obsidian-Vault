...
| Lever                     | Mechanism                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Strategic alignment**   | Without a capability map, spend gets approved on momentum, not priority. A group reference architecture makes it visible which projects map to a strategic capability and which don't, with a fund, defer or kill recommendation logged for each. The investment decision stays with you; what changes is that nothing gets funded by default.                                                                              |
...
| **Decision latency**      | Cross-region decisions escalate to committee because no group layer owns them. A deferred decision defers the benefit stream behind it - month one puts a number on that.                                                                                                                                                                                                                                                  |
| **Risk control**          | Programmes that self-certify their own design are how large overruns and late re-cuts happen - the people accountable for the date are also the people judging whether it's sound. Independent assurance separates those two jobs, so problems surface while they're still cheap to fix. The NA ERP result is what it looks like when that discipline holds; the value is in making it repeatable rather than exceptional. |
| **Procurement leverage**  | Steve's point on the results call - leveraging negotiating costs on IT to free up cash. Fewer regional variants means fewer, larger vendor negotiations instead of several small ones. Standardising is what makes that possible; the negotiating itself stays procurement's job.                                                                                                                                          |
