...
An example for the first source, recurring savings: if the fee had to wash its face on those alone, it breaks even at US$132,500 a year - three-year view, 10% discount rate, no benefit counted in year one while the structure is built. I don't have sight of your group technology spend, but if the estate is anything like the scale I'd expect for a US$15.3bn business, that is a small fraction of it. In practice the return is more likely a blend of all three sources, in whatever mix reflects how you decide to use me - and month one starts putting your own numbers on it either way.
