...
- **"Where have you done this before?"** 🟡 **PARKED — Julian to think through (flagged critical, 19 Jul).** This is the prior-proof of an actual *governance forum that retired reconciliation overhead* — the evidentiary backbone of the whole pitch, and Julian wants to develop it properly rather than reach for a quick candidate. Candidates to draw from: Global Head of Enterprise Solution Architecture at Telstra International (governing US$200M+ of designs to one standard); US$300M+ managed-services transformation governed across many streams. *Needs the concrete before/after: what forum, what it replaced, what stopped needing a committee. Come back to this.*
