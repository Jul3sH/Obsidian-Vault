# DDG Alternative Proposal - Draft
...
On the ranges in your own brief, the audition could consume 18 to 50 candidate-weeks across up to five separately managed engagements: five onboardings, five sets of controlled access to your systems and data, five directions of travel, and management attention from leaders who would rather be running the business. Each candidate builds to demonstrate; only later does someone integrate. The test is real, but the accountability is fragmented, and nobody owns the whole answer until the process is over.
...
Every stage is a fixed fee against a written statement of work, with the outcomes defined and agreed by both sides before it starts. Your protection is the gate: each stage has to earn the next, and you can stop at any gate and keep everything.

| Stage | Length | You pay | You get |
|-------|--------|---------|---------|
| 1. Find and baseline | 2-3 weeks | [HK$ fixed fee] | One bounded, high-value constraint agreed and baselined, a working demonstration against it, and a plain-language plan. |
| 2. Deliver the improvement | 4-6 weeks | [HK$ fixed fee] | A measurable improvement against the agreed target, including a production-quality AI workflow where that is the right intervention, with your team using it. |
| 3. Keep compounding | Monthly, fractional | [HK$ monthly retainer] | Ongoing senior AI leadership without a C-suite salary: the next constraint, then the next. Cancel any month. |

If the work stops after stage one, you still hold something the audition was not designed to give you: a costed, evidenced view of what to build and who to hire, ready to take to market or to tender if you choose.

## Who you'd be dealing with

- **[Dean], Hong Kong engagement lead.** [One-line credential: specific shipped AI result.] Accountable for delivery, present onsite at an agreed cadence [state cadence before sending], the person you hold accountable.
- **[Julian], UK.** [One-line credential: specific enterprise architecture result.] Leads architecture, decision systems and the operating model, with daily working overlap through Hong Kong afternoons.

One company, senior people only, no juniors learning on your time.
...
Thirty minutes with us both. Bring one candidate constraint; in that half hour we will test whether it is valuable and bounded enough for stage one, and show you how we would approach the first fortnight.
