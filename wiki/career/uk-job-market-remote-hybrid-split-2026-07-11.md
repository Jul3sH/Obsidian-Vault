...
This sharpens the income/geography arm of the pre-agreed reopen condition; it does not by itself reopen the [[uk-relocation-project|relocation decision]] (see [[commitment-lock-protocol]]). Current reading: London is where his *stated* target role concentrates; Malvern is viable only if he changes the target (cleared contract).
...
- [[uk-relocation-project|UK Relocation Project]] - the project this informs (London-direct vs Malvern-first sub-decision)
