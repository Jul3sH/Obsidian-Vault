...
> Pipes the `claude` CLI to your phone via Telegram. Not a chatbot wrapper - spawns the real Claude Code binary, so every skill, tool, and context you have in the terminal works from your phone.
