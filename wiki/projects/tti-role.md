...
**Latest: the Ty proposal has now had its independent Codex adversarial review. Verdict: [[tti-ty-engagement-proposal-codex-review-2026-08-07]] says "send with the FATAL fix, do not send as-is." The fatal issue is not the price or the NPV math, both check out. It is that the proposal asks Ty to make a no-break 12-month commitment while month 1 still reads like the point where the benefit case gets measured. The fix is to make month 1 visible execution on one live cross-region decision, not just discovery.**
