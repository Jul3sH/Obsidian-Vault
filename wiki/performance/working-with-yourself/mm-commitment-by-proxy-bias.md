...
created: 2026-09-19
status: active
tags: [working-with-yourself, cognitive-bias, working-with-genai, mental-models]
---
...
- Applies to commitments and grounding briefs, not to ordinary drafting - the model drafting analysis, articles, or messages for review is normal division of labour.

## Detail

Register entry and lock conditions: [[commitment-lock-protocol]]. Companion rule: the prompt-zero skill. Row in [[biases-index]].
