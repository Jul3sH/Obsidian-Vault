...
> *Navigation only: every documented personal bias, keyed by the situation in which it fires. Each row links the bias's mm card; the card links onward to detail and countermeasures. Maintained under the every-bias-has-a-card rule in `documentation-conventions.md` Part 1.*
