...
| youtube-notebook | `~/.claude/skills/youtube-notebook/SKILL.md` | [[../../skills/youtube-notebook/SKILL\|SKILL.md]] | 2026-07-29 (new skill: verified-complete YouTube channel ingest, per-source native briefing docs, title correlation) |
...
| youtube-notebook/scripts | `~/.claude/skills/youtube-notebook/scripts/build_notebook.py` | [[../../skills/youtube-notebook/scripts/build_notebook\|build_notebook.md]] | 2026-07-29 (new) |
...
| MEMORY.md | `~/.claude/projects/.../memory/MEMORY.md` | [[memory/MEMORY\|MEMORY.md]] | 2026-08-01 (added feedback-verify-before-writing.md row) |
...
| ~~projects.md~~ **(RETIRED 2026-07-31)** | `~/.claude/projects/.../memory/projects.md` | [[memory/projects\|projects.md]] | 2026-06-30 (CLSA split: First Interview (clsa-role) closed Done; Second Interview (clsa-second-interview, M, WSJF 3.8) added as active, deadline-driven, POR-21) |
| ~~deliverables.md~~ **(RETIRED 2026-07-31)** | `~/.claude/projects/.../memory/deliverables.md` | [[memory/deliverables\|deliverables.md]] | 2026-06-09 (renamed from project.md; points to wiki/deliverables/, timebox vocab) |
