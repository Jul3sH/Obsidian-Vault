...
| [[../../projects/ai-engineering-patterns\|AI Engineering Patterns]] | Performance | XS | 5-8 | 2h | TBD | TBD | N/A - Output | Two hard 2h timeboxes (catalog + mm models; routing skill + evals) plus Julian's review. Originally intended as a 2h all-in XXS before the routing skill merged in. Overflow risk = Codex verification rounds; the boxes stop the work, remainder re-scopes. Scoped so far: pattern articles task 2h (defined 20 Aug); routing-skill enabler not yet defined. |
