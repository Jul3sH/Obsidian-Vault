...
|---------|-----------|---------------|--------------|-----------|-----------|----------|------------|------------------|
| [[../../projects/tti-role\|TTI Role]] | Career | S | 9-16 | 15h | TBD | TBD | Medium | 3 queued tasks: Framework Content (5h) + Case Studies (6h) + NotebookLM Practice (4h). Scoped hrs (15h) at top of S band - watch at close. |
