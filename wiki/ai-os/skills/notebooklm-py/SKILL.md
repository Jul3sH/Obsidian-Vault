> **Mirror copy.** Source: `~/.claude/skills/notebooklm-py/SKILL.md`
...
- **Command surface verified against CLI v0.7.0 on 2026-07-29.** The pre-0.7 signatures previously documented here were all broken; see `references/TESTING.md`.
