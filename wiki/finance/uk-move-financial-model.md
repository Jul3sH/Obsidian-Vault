...
> **⚠ As of 25 Sep 2026: the runway rows in the table below are superseded.** The live runway now comes from the v3 savings sheet's runway blocks, which include property tax, the FIG position, corrected living costs and the 25 Sep cash balances (net cash HK$788k after cards, not the £50-55k pots below). No-salary runway, cash only: London 15.6 months, Malvern 34.4 months, Hong Kong 11.8 months; with ISAs 6.7 / 14.8 / 5.0 years; with MPF as well 8.8 / 19.3 years (HK n/a). Malvern's figure uses HK$2,000/mo of board and car against the ~HK$7,250 honest uplift below, so treat Malvern as ~28 months cash-only for planning. Explanation: [[uk-relocation-savings-comparison]] §3 and §4; mechanics: [[uk-relocation-cashflows]] §6b. The burn rows below remain the July derivation and are kept for the record.
